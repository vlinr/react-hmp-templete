...
function setHtmlFontSize(params:FontType={
    maxWidth:750,
    designWidth:375,
    fontSize:14
}){
...
export function setSize(params:FontType){
    ...
    if (width > params.maxWidth) {
        document.documentElement.style.fontSize = params.maxWidth / params.designWidth * params.fontSize + "px";
    } else {
        document.documentElement.style.fontSize = width / params.designWidth * params.fontSize + "px";
    }
}
