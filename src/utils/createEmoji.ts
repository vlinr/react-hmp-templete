...
class CreateEmoji {
     ...
     * 
     * ****/
    public initEmoji():Array<{name:string,value:string}>{
        this.fromCodePoint();
        let emojiArr = [];
